#!/usr/bin/env bash
#
# Build a self-contained Tomoru.app for macOS.
#
...
#
# Output: dist/Tomoru.app — drag it into /Applications or run
#         `open dist/Tomoru.app` to launch.
...
chmod +x "$APP/Contents/MacOS/Tomoru"
...
<plist version="1.0">
<dict>
    <key>CFBundleName</key>            <string>tomoru</string>
    <key>CFBundleDisplayName</key>     <string>灯る · tomoru</string>
    <key>CFBundleIdentifier</key>      <string>dev.tomoru</string>
    <key>CFBundleExecutable</key>      <string>Tomoru</string>
...
ZIP="$DIST/Tomoru-mac-${RID#osx-}.zip"
echo "▸ zipping ..."
rm -f "$ZIP"
