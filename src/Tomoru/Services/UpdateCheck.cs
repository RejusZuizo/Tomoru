...
/// <summary>
/// The launch-time update check — the whole of tomoru's network story.
...
{
    public const string ReleasesUrl = "https://github.com/RejusZuizo/Tomoru/releases/latest";
    private const string ApiUrl = "https://api.github.com/repos/RejusZuizo/Tomoru/releases/latest";
        ...
        string current, HttpMessageHandler? handler = null)
    {
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.Add(
                new ProductInfoHeaderValue("tomoru", ReleaseNotes.Version));
