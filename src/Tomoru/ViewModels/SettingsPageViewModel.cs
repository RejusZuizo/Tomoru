...
public partial class SettingsPageViewModel : ViewModelBase
{
    ...
    public string VersionLabel => $"灯る · tomoru · {ReleaseNotes.VersionTag}";
    ...
    /// doesn't parse as a tomoru backup is refused whole — no half
    ...
    public void TryRestoreBackup(string json)
    {
        ...
        if (restored is null)
        {
            RestoreStatus = "that file didn't read as a tomoru backup — nothing was changed";
            return;
        }
    ...
    public string BuildTimetableIcs()
    {
        ...
        Line("VERSION:2.0");
        Line("PRODID:-//tomoru//timetable//EN");
